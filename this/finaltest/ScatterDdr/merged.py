...
class Scattering(Base):
    ...
    def createGridGeomd(self, theta, phi, outFile = 'geom.xyz'):
    ...
    def createDdrGridGeom(self, theta, phi):
        self.createGridGeomd(theta,    phi,    'geom1.xyz')
        self.createGridGeomd(theta+self.dt, phi,   'geom2.xyz')
        self.createGridGeomd(theta-self.dt, phi,   'geom3.xyz')
        self.createGridGeomd(theta,    phi+self.dp,'geom4.xyz')
        self.createGridGeomd(theta,    phi-self.dp,'geom5.xyz')
