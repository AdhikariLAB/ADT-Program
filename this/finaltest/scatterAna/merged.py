...
class Scattering(Base):
    ...
    def createDdrGridGeom(self, theta, phi):
        self.createGridGeom(atomNames, theta,    phi,    'geom1.xyz')
        self.createGridGeom(atomNames, theta+self.dt, phi,   'geom2.xyz')
        self.createGridGeom(atomNames, theta-self.dt, phi,   'geom3.xyz')
        self.createGridGeom(atomNames, theta,    phi+self.dp,'geom4.xyz')
        self.createGridGeom(atomNames, theta,    phi-self.dp,'geom5.xyz')
