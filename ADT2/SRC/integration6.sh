...
#solving of ADT equations along each negative step of first coordinate at lowest value of second coordinate 
echo "      TR=RR1(MM1+2)+0.5D0*H                                             " >> integration.h
echo "      TP=PH1(1)                                                         " >> integration.h                                                      
echo "      TOUTP=PH(1)                                                       " >> integration.h  
echo "*                                                                       " >> integration.h
echo "      DO I=1,NN                                                         " >> integration.h
echo "      Y(I)=0.0D0     ! Initial values of ADT angles.                    " >> integration.h
echo "      ENDDO                                                             " >> integration.h    
echo "*                                                                       " >> integration.h
echo "      DO I=MM1,1,-1                                                     " >> integration.h
...
#solving of ADT equations along each positive step of second coordinate for each value of first coordinate
echo "      DO I=MM1,1,-1                                                     " >> integration.h
