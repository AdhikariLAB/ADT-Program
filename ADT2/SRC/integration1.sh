...
#solving of ADT equations along each positive step of second coordinate at lowest value of first coordinate 
echo "      TR=RR1(1)                                                         " >> integration.h
echo "      TP=PH1(1)+0.5D0*H                                                 " >> integration.h                                                      
echo "      TOUTR=RR(1)                                                       " >> integration.h  
echo "*                                                                       " >> integration.h
...
#solving of ADT equations along each positive step of first coordinate for each value of second coordinate
echo "      DO I=1,MM2                                                        " >> integration.h
