...
echo "      H=(PH(2)-PH(1))                                                   " >> integration.h

#solving of ADT equations along each positive step of second coordinate at highest value of first coordinate 
echo "      TR=RR1(MM1+2)                                                     " >> integration.h
echo "      TP=PH1(1)+0.5D0*H                                                 " >> integration.h                                                      
echo "      TOUTR=RR(MM1)                                                     " >> integration.h  
echo "*                                                                       " >> integration.h
echo "      DO I=1,NN                                                         " >> integration.h
echo "      Y(I)=0.0D0     ! Initial values of ADT angles.                    " >> integration.h
echo "      ENDDO                                                             " >> integration.h    
echo "*                                                                       " >> integration.h
echo "      DO I=1,MM2                                                        " >> integration.h
...
#solving of ADT equations along each negative step of first coordinate for each value of second coordinate
echo "      DO I=1,MM2                                                        " >> integration.h
echo "         TOUTP=PH(I)                                                    " >> integration.h
echo "         TP=TOUTP                                                       " >> integration.h
echo "         DO K=1,NN                                                      " >> integration.h
echo "            Y(K)=YY(I,K)                                                " >> integration.h
echo "         ENDDO                                                          " >> integration.h
echo "CCC                                                                     " >> integration.h
echo "         H=RR(1)-RR(2)                                                  " >> integration.h
echo "         TR=RR1(MM1+2)+0.5D0*H                                          " >> integration.h
echo "         DO J=MM1,1,-1                                                  " >> integration.h 
echo "           DO K=1,NN                                                    " >> integration.h
echo "              Y1(K)=Y(K)                                                " >> integration.h
echo "           ENDDO                                                        " >> integration.h
...
echo "     $             +49.0D0*AK10(K)+9.0D0*AK11(K))/180.0D0               " >> integration.h
echo "           ENDDO                                                        " >> integration.h 
echo "           TR=RR(J)                                                     " >> integration.h 
echo "C                                                                       " >> integration.h
echo "           DO K=1,NN                                                    " >> integration.h
echo "             YYY(J,I,K)=Y(K)                                            " >> integration.h
echo "           ENDDO                                                        " >> integration.h
echo "*                                                                       " >> integration.h
echo "*                                                                       " >> integration.h
...
echo "           DO K=1,NN                                                    " >> integration.h
echo "             WRITE($A+K,33)RR(J),PH(I),Y(K)                             " >> integration.h
echo "           ENDDO                                                        " >> integration.h
echo "C                                                                       " >> integration.h
...
echo "              WRITE($B+II,44)RR(J),PH(I),(AA(II,JJ),JJ=1,N)             " >> integration.h
echo "           ENDDO                                                        " >> integration.h
echo "*                                                                       " >> integration.h
echo "           DO II=1,N                                                    " >> integration.h
echo "              DO JJ=1,N                                                 " >> integration.h
echo "                IF(II.EQ.JJ)THEN                                        " >> integration.h
echo "                   UMAT(II,JJ)=UU(J,I,II)                               " >> integration.h
...
echo "           DO II=1,N                                                    " >> integration.h
echo "              WRITE($C+II,44)RR(J),PH(I),(WA(II,JJ),JJ=1,N)             " >> integration.h
echo "           ENDDO                                                        " >> integration.h
echo "*                                                                       " >> integration.h
echo "         ENDDO                                                          " >> integration.h
echo "                                                                        " >> integration.h
