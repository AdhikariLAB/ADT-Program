...
OMEGA1=1047.52*CMINVTINV;
OMEGA2=745.13*CMINVTINV;
OMEGA3=1185.60*CMINVTINV;
OMEGA4=1185.85*CMINVTINV;
OMEGA5=476.88*CMINVTINV;
OMEGA6=476.91*CMINVTINV;
...
if(j.eq.1)then
{multi;occ,19;closed,11;wf,31,1,1,0;state,5;
       start,2140.2;orbital,2140.2+j;}
!elseif(i.eq.1.and.j.eq.k)then
!{multi;occ,19;closed,11;wf,31,1,1,0;state,5;
!       start,2140.2+(j-2);orbital,2140.2+j;}
else
{multi;occ,19;closed,11;wf,31,1,1,0;state,5;
       start,2140.2+(j-1);orbital,2140.2+j;}
endif
...
{multi;occ,19;closed,11;wf,31,1,1,0;state,5;start,2140.2+j;orbital,2350.2;
...
cpmcscf,nacm,2.1,4.1,record=5106.1;
cpmcscf,nacm,2.1,5.1,record=5107.1;
}
...
{multi;occ,19;closed,11;wf,31,1,1,0;state,5;start,2140.2+j;orbital,2350.2;
cpmcscf,nacm,3.1,4.1,record=5108.1;
cpmcscf,nacm,3.1,5.1,record=5109.1;
cpmcscf,nacm,4.1,5.1,record=5110.1;
}
